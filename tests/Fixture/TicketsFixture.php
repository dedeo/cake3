...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stock' => ['type' => 'string', 'length' => 20, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'schedule_id' => 1,
            'create_at' => '2016-12-27 09:13:28',
            'departure_time' => '09:13:28',
            'date' => '2016-12-27',
            'arival_time' => '09:13:28',
